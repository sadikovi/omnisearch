...
export default class SearchView {
  constructor(serializedState) {
    ...
    const filePanel = new ResultView('Files', '25+');
    const contentPanel = new ResultView('Content', '96+');
    this.element.appendChild(controlPanel);
    this.element.appendChild(filePanel.element);
    this.element.appendChild(contentPanel.element);
  }
