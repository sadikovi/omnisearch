...
export default class SearchInfoView {
  constructor(serializedState) {
    ...
    this.element.appendChild(this.section("Files"));
    this.element.appendChild(this.section("Content"));
  ...
  section(name) {
    ...
    counter.classList.add('badge', 'badge-medium');
    counter.textContent = "37+";
  ...
  panel() {
    const section = document.createElement('section');
    section.classList.add('bordered', 'control-panel');
